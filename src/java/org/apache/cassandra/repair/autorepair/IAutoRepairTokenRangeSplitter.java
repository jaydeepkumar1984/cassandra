...
public interface IAutoRepairTokenRangeSplitter
{
     ...
     */
    List<RepairAssignment> getRepairAssignments(AutoRepairConfig.RepairType repairType, boolean primaryRangeOnly, String keyspaceName, Set<String> tableNames);
    ...
    class RepairAssignment
    {
        ...
        public RepairAssignment(Range<Token> tokenRange, String keyspaceName, Set<String> tableNames)
        {
